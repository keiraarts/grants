...
function _handler() {
  _handler = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(req, res) {
    var method, jwt, user, programs, sample;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.t0 = method;
            _context.next = _context.t0 === "GET" ? 6 : 28;
            break;
          ...
          case 16:
            ...
            _context.next = 19;
            return _models_programModel__WEBPACK_IMPORTED_MODULE_7__.default.findById("60708c75525e3e035e8e2eb8").select("organizer name url perpetual passByVotes topThreshold voteThreshold blindVoting mintToArtist hideResults curationLock finalized mintInProgress").populate("organizers");
