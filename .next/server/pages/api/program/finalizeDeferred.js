...
function _handler() {
  _handler = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(req, res) {
    var method, jwt, organizer, program;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.t0 = method;
            _context.next = _context.t0 === "POST" ? 6 : 28;
            break;
          ...
          case 20:
            req.body.applicants.forEach(function (applicant) {
              _models_programApplicantModel__WEBPACK_IMPORTED_MODULE_5__/* .default.findById */ .Z.findById(applicant.id).then(function (data) {
                data.finalized = true;
                data.save();
              });
            });
            return _context.abrupt("return", res.json({
              success: "Deferrment finalized"
            }));
...
var __webpack_exports__ = (__webpack_exec__(4823));
