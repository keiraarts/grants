...
function _handler() {
  _handler = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(req, res) {
    var method, jwt, user, org, newProgram;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            _context.next = 12;
            return _models_organizerModel__WEBPACK_IMPORTED_MODULE_5__.default.findById(req.body.existing);
          ...
          case 12:
            ...
            return _context.abrupt("return", res.json({
              error: "That org does not seem to exist"
            }));
          ...
          case 17:
            org = new _models_organizerModel__WEBPACK_IMPORTED_MODULE_5__.default({
              admins: [jwt.id],
          ...
          case 19:
            newProgram = new _models_programModel__WEBPACK_IMPORTED_MODULE_6__.default({
              organizers: [org._id],
              name: req.body.name,
            ...
            _context.t0 = method;
            _context.next = _context.t0 === "POST" ? 23 : 25;
            break;
