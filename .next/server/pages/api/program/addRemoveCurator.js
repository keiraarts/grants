...
/* harmony import */ var _models_organizerModel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6076);
/* harmony import */ var _models_programModel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8735);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _context.next = 10;
            return _models_organizerModel__WEBPACK_IMPORTED_MODULE_4__.default.findOne({
              admins: jwt.id
            });
          ...
          case 13:
            ...
            return _context.abrupt("return", res.json({
              error: "You cannot add or remove yourself"
            }));

          case 15:
            return _context.abrupt("return", _models_programModel__WEBPACK_IMPORTED_MODULE_5__.default.findById(req.body.program, function (err, data) {
              if (!data.organizers.find(function (e) {
                return e.equals(organizer._id);
              })) return res.json({
                error: "Authentication error"
              });
              var index = data.curators.findIndex(function (e) {
                return e.equals(req.body.curator);
              });
              ...
              if (req.body.type === "remove") {
                ...
                if (index < 0) {
                  ...
                  data.save();
                  return res.json({
                    success: "Curator added"
                  });
                }
              }

              return res.json({
                error: "Could not find curator"
              });
            }));
