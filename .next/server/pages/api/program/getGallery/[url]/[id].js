...
var dbConnect = __webpack_require__(7547);
// EXTERNAL MODULE: ./models/programApplicantModel.js
var programApplicantModel = __webpack_require__(935);
// EXTERNAL MODULE: ./models/programModel.js
var programModel = __webpack_require__(8735);
;// CONCATENATED MODULE: external "probe-image-size"
var external_probe_image_size_namespaceObject = require("probe-image-size");;
var external_probe_image_size_default = /*#__PURE__*/__webpack_require__.n(external_probe_image_size_namespaceObject);
;// CONCATENATED MODULE: ./pages/api/program/getGallery/[url]/[id].js
...
function _handler() {
  _handler = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(req, res) {
    var _req$query, _req$query$url, url, _req$query$id, id, method, program;

    return regenerator_default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _req$query = req.query, _req$query$url = _req$query.url, url = _req$query$url === void 0 ? "gallery" : _req$query$url, _req$query$id = _req$query.id, id = _req$query$id === void 0 ? "148" : _req$query$id;
            method = req.method;
            _context2.next = 4;
            return (0,dbConnect/* default */.Z)();

          case 4:
            _context2.t0 = method;
            _context2.next = _context2.t0 === "GET" ? 7 : 13;
            break;

          case 7:
            _context2.next = 9;
            return programModel.default.findOne({
              url: url
            }).populate("organizers").populate("curators", "artistName first last instagram twitter website");

          case 9:
            program = _context2.sent;
            _context2.next = 12;
            return programApplicantModel/* default.findOne */.Z.findOne({
              program: program._id,
              order: id.toString(),
              published: true
            }, /*#__PURE__*/function () {
              var _ref = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(err, gallery) {
                var imageMetadata;
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.prev = 2;
                        _context.next = 5;
                        return external_probe_image_size_default()("https://cdn.grants.art/".concat(gallery.artWeb));

                      case 5:
                        imageMetadata = _context.sent;
                        _context.next = 11;
                        break;
                      ...
                      case 11:
                        return _context.abrupt("return", err ? res.status(400).json(err) : res.json({
                          gallery: gallery,
            ...
            }()).select("-approved -rejected -program -statement -additional -ineligible -flagged -approvalCount -rejectCount -emailed -accepted").populate("user", "artistName birthYear country city website twitter instagram").sort("order");
...
var __webpack_exports__ = (__webpack_exec__(8764));
