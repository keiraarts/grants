...
/* harmony import */ var _src_server_services_authorization_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(879);
/* harmony import */ var _src_server_services_authorization_service__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_src_server_services_authorization_service__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _src_server_emails_templates__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1816);
/* harmony import */ var _utils_dbConnect__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7547);
/* harmony import */ var _models_programApplicantModel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(935);
/* harmony import */ var _models_organizerModel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(6076);
/* harmony import */ var _models_programModel__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(8735);
...
function _handler() {
  _handler = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2(req, res) {
    var method, _ret;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            method = req.method;
            _context2.next = 3;
            return (0,_utils_dbConnect__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z)();

          case 3:
            _context2.t0 = method;
            _context2.next = _context2.t0 === "GET" ? 6 : 17;
            break;
          ...
          case 6:
            ...
            return _context2.delegateYield( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee() {
              var jwt, organizer, program, order, _iterator, _step, applicant;

              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      jwt = _src_server_services_authorization_service__WEBPACK_IMPORTED_MODULE_3___default()(req.headers.authorization, res, function (jwt) {
                        return jwt;
                      });
                      _context.next = 3;
                      return _models_organizerModel__WEBPACK_IMPORTED_MODULE_7__.default.findOne({
                        _id: req.body.org,
                        admins: jwt.id
                      });
                    ...
                    case 6:
                      _context.next = 8;
                      return _models_programModel__WEBPACK_IMPORTED_MODULE_8__.default.findById(req.body.program);
                    ...
                    case 13:
                      order = program.total + 1;
                      _iterator = _createForOfIteratorHelper(req.body.applicants);
                      _context.prev = 15;
                    ...
                    case 17:
                      ...
                      applicant = _step.value;
                      _context.next = 21;
                      return _models_programApplicantModel__WEBPACK_IMPORTED_MODULE_6__/* .default.findById */ .Z.findById(applicant.id).then(function (data) {
...
var __webpack_exports__ = (__webpack_exec__(6319));
