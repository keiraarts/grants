...
var ENV = process.env;
var transporter = nodemailer__WEBPACK_IMPORTED_MODULE_14___default().createTransport({
...
var compressor = /*#__PURE__*/function () {
  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2(file, fileWeb) {
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt("return", new Promise(function (resolve) {
              var input = path.join(__dirname, "../../images/".concat(file));
              var output = path.join(__dirname, "../../images/".concat(fileWeb));
              var write = fs__WEBPACK_IMPORTED_MODULE_18___default().createWriteStream(output);
              var fileType = file.split(".")[1];

              if (fileType === "gif") {
                console.log("DOING FILE", file);
                var buf = fs__WEBPACK_IMPORTED_MODULE_18___default().readFileSync(input);
                _gumlet_gif_resize__WEBPACK_IMPORTED_MODULE_11___default()({
                  width: 600,
                  optimizationLevel: 3
                })(buf).then( /*#__PURE__*/function () {
                  var _ref2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(data) {
                    var stream;
                    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            stream = new stream__WEBPACK_IMPORTED_MODULE_13__.Duplex();
                            stream.push(data);
                            stream.push(null);
                ...
                get_media_dimensions__WEBPACK_IMPORTED_MODULE_9___default()(input, "video").then(function (dimensions) {
                  var width = 600;
                  var height = Math.round(width / dimensions.width * dimensions.height);
                  console.log(width, height);
                  (0,node_video_resize__WEBPACK_IMPORTED_MODULE_10__.videoResize)({
                    inputPath: input,
                    outputPath: output,
                    format: "mp4",
                ...
                console.log("ELSING");
                var read = (0,util__WEBPACK_IMPORTED_MODULE_12__.promisify)((fs__WEBPACK_IMPORTED_MODULE_18___default().readFile));
                read(input).then(function (result) {
                  return jimp__WEBPACK_IMPORTED_MODULE_17___default().read(result);
                }).then(function (img) {
                  var r = img.resize(600, (jimp__WEBPACK_IMPORTED_MODULE_17___default().AUTO));
                  var b = (0,util__WEBPACK_IMPORTED_MODULE_12__.promisify)(r.getBuffer.bind(r));
                  return b((jimp__WEBPACK_IMPORTED_MODULE_17___default().AUTO));
                }).then(function (buff) {
                  var stream = new stream__WEBPACK_IMPORTED_MODULE_13__.Duplex();
                  stream.push(buff);
                  stream.push(null);
                  return stream;
  ...
  return function compressor(_x, _x2) {
...
function _handler() {
  _handler = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee4(req, res) {
    var method, jwt, user, program, applied, applicant, newApplicant;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            _context4.next = 6;
            return _models_userModel__WEBPACK_IMPORTED_MODULE_8__.default.findById(jwt.id);
          ...
          case 9:
            if (!(!user.artistName || !user.city || !user.country || !user.twitter || !user.instagram || !user.website || !user.emailVerified || !user.wallet)) {
              _context4.next = 11;
              break;
            }
          ...
          case 11:
            if (!(!req.body.program || !req.body.statement || !req.body.title || !req.body.description || !req.body.art)) {
              _context4.next = 13;
              break;
            }
          ...
          case 13:
            _context4.next = 15;
            return _models_programModel__WEBPACK_IMPORTED_MODULE_7__.default.findById(req.body.program);
          ...
          case 18:
            ...
            return _context4.abrupt("return", res.json({
              error: "The secret phrase was incorrect"
            }));
          ...
          case 27:
            ...
            _context4.next = 30;
            return Object.keys(req.body).forEach( /*#__PURE__*/function () {
              var _ref3 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee3(item) {
                var ext, image, buf, name, saveImage, uploader, uploader2;
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        buf = new Buffer.from(image, "base64");
                        name = crypto__WEBPACK_IMPORTED_MODULE_16___default().randomBytes(20).toString("hex");
                        applicant.art = "".concat(name, ".").concat(ext);
                        applicant.artWeb = "".concat(name, "-web.").concat(ext);
                        saveImage = (0,util__WEBPACK_IMPORTED_MODULE_12__.promisify)((fs__WEBPACK_IMPORTED_MODULE_18___default().writeFile));
                        _context3.next = 11;
                        return saveImage(path.join(__dirname, "../../images/".concat(applicant.art)), buf);

                      case 11:
                        _context3.next = 13;
                        return compressor(applicant.art, applicant.artWeb);
                      ...
                      case 13:
                        ...
                        _context3.next = 16;
                        return handbrake_js__WEBPACK_IMPORTED_MODULE_15___default().run({
                          input: path.join(__dirname, "../../images/".concat(applicant.art)),
                          output: path.join(__dirname, "../../images/video-".concat(applicant.art)),
                      ...
                      case 16:
                        ...
                        return spaces.uploadFile({
                          localFile: path.join(__dirname, "../../images/".concat(ext === "mp4" ? "video-".concat(applicant.art) : applicant.art)),
                          s3Params: {
                            Bucket: "grants",
                            Key: "".concat(applicant.art),
                            ACL: "public-read"
                          }
                        });

                      case 18:
                        uploader = _context3.sent;
                        console.log("uploading");
                        _context3.next = 22;
                        return spaces.uploadFile({
                          localFile: path.join(__dirname, "../../images/".concat(applicant.artWeb)),
                          s3Params: {
                            Bucket: "grants",
                            Key: "".concat(applicant.artWeb),
                            ACL: "public-read"
                          }
                        });

                      case 22:
                        uploader2 = _context3.sent;
                        uploader.on("end", function () {
                          fs__WEBPACK_IMPORTED_MODULE_18___default().unlink(path.join(__dirname, "../../images/".concat(applicant.art)), function (err2) {
                            if (err2 !== null) {
                              console.log(err2);
                            }
                          ...
                          if (ext === "mp4") {
                            fs__WEBPACK_IMPORTED_MODULE_18___default().unlink(path.join(__dirname, "../../images/video-".concat(applicant.art)), function (err2) {
                              if (err2 !== null) {
                                console.log(err2);
                              }
                        ...
                        uploader2.on("end", function () {
                          fs__WEBPACK_IMPORTED_MODULE_18___default().unlink(path.join(__dirname, "../../images/".concat(applicant.artWeb)), function (err2) {
                            if (err2 !== null) {
                              console.log(err2);
                            }
          ...
          case 30:
            newApplicant = new _models_programApplicantModel__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z(applicant);
            newApplicant.save(function (err, data) {
              if (err) return res.status(500).json(err);else {
                transporter.sendMail(_src_server_emails_templates__WEBPACK_IMPORTED_MODULE_3__.applicationConfirmation(user.email, program.name));
...
var __webpack_exports__ = (__webpack_exec__(8731));
