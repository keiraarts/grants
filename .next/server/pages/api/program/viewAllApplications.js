    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.t0 = method;
            _context.next = _context.t0 === "POST" ? 6 : 25;
            break;
          ...
          case 18:
            return _context.abrupt("return", _models_programApplicantModel__WEBPACK_IMPORTED_MODULE_5__/* .default.find */ .Z.find({
              ...
              data.forEach(function (e) {
                if (e.approved.find(function (g) {
                  return g._id.equals(jwt.id);
                })) approved.push(e);else if (e.rejected.find(function (g) {
                  return g._id.equals(jwt.id);
                })) rejected.push(e);else unapproved.push(e);
              });
...
var __webpack_exports__ = (__webpack_exec__(4350));
