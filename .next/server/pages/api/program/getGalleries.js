...
/* harmony import */ var _models_programModel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8735);
...
function _handler() {
  _handler = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2(req, res) {
    var method, programs, galleries, merged;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _context2.t0 = method;
            _context2.next = _context2.t0 === "GET" ? 6 : 15;
            break;

          case 6:
            _context2.next = 8;
            return _models_programModel__WEBPACK_IMPORTED_MODULE_3__.default.find({
              exhibiting: true
            }).populate("organizers").populate("curators", "artistName first last instagram twitter website");

          case 8:
            programs = _context2.sent;
            galleries = programs.map( /*#__PURE__*/function () {
              var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(program) {
                var gallery;
                return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        _context.next = 2;
                        return _models_programApplicantModel__WEBPACK_IMPORTED_MODULE_4__/* .default.find */ .Z.find({
                          program: program._id,
                          published: true
                        }, function (err, gallery) {
                          return err ? res.status(500).json(err) : gallery.forEach(function (e) {
