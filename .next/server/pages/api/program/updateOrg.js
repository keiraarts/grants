      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            _context2.next = 6;
            return _models_organizerModel__WEBPACK_IMPORTED_MODULE_6__.default.findOne({
              _id: req.body._id,
              admins: jwt.id
            });
          ...
          case 9:
            ...
            _context2.t0 = method;
            _context2.next = _context2.t0 === "POST" ? 19 : 30;
            break;
          ...
          case 19:
            ...
            return Object.keys(req.body).forEach( /*#__PURE__*/function () {
              var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(item) {
                var ext, image, buf, name, uploader;
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        org.logo = "".concat(name, ".").concat(ext);
                        _context.next = 9;
                        return fs__WEBPACK_IMPORTED_MODULE_18___default().writeFileSync(path.join(__dirname, "../../images/".concat(org.logo)), buf);

                      case 9:
                        _context.next = 11;
                        return spaces.uploadFile({
                          localFile: path.join(__dirname, "../../images/".concat(org.logo)),
                          s3Params: {
                            Bucket: "grants",
                            Key: "".concat(org.logo),
                            ACL: "public-read"
                      ...
                      case 11:
                        ...
                        uploader.on("end", function () {
                          fs__WEBPACK_IMPORTED_MODULE_18___default().unlink(path.join(__dirname, "../../images/".concat(org.logo)), function (err2) {
                            if (err2 !== null) {
                              console.log(err2);
                            }
...
var __webpack_exports__ = (__webpack_exec__(6408));
