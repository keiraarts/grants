...
/* harmony import */ var _models_userModel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3309);
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(5747);
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.t0 = method;
            _context.next = _context.t0 === "POST" ? 6 : 27;
            break;
          ...
          case 6:
            ...
            _context.next = 10;
            return _models_userModel__WEBPACK_IMPORTED_MODULE_7__.default.findById(jwt.id);
          ...
          case 13:
            _context.next = 15;
            return _models_programModel__WEBPACK_IMPORTED_MODULE_6__.default.find({
              curators: user._id
            });

          case 15:
            isCurator = _context.sent;
          ...
          case 18:
            ...
            return _context.abrupt("return", res.json({
              error: "Curation locked"
            }));

          case 20:
            return _context.abrupt("return", _models_programApplicantModel__WEBPACK_IMPORTED_MODULE_4__/* .default.findById */ .Z.findById(req.body.id, function (err2, data) {
              if (err2) return res.status(500).json(err);else {
                if (req.body.type === "approve") {
                  var index = data.approved.findIndex(function (e) {
                    return e.equals(jwt.id);
                  });
                  ...
                  var _index = data.rejected.findIndex(function (e) {
                    return e.equals(jwt.id);
                  });
