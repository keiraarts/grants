...
/* harmony import */ var crypto__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6417);
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            try {
              _models_userModel__WEBPACK_IMPORTED_MODULE_4__.default.findOne({
                $or: [{
                  email: {
                    $regex: new RegExp("^".concat(req.body.recovery.toLowerCase().trim(), "$"), "i")
                  }
                }, {
                  username: {
                    $regex: new RegExp("^".concat(req.body.recovery.toLowerCase().trim(), "$"), "i")
                ...
                if (err) {
                  ...
                  return res.status(401).json("Could not find user: ".concat(req.body.username));
                  ...
                  user.recoveryToken = crypto__WEBPACK_IMPORTED_MODULE_5___default().randomBytes(32).toString("hex");
                  var expires = new Date();
                  expires.setHours(expires.getHours() + 24);
                  user.recoveryExpiration = expires;
                  user.save();
                  transporter.sendMail(_src_server_emails_templates__WEBPACK_IMPORTED_MODULE_2__.passRecovery(user.email, user.username, user.recoveryToken));
                }
...
var __webpack_exports__ = (__webpack_exec__(7912));
