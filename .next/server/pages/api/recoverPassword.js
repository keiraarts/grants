...
/* harmony import */ var crypto__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6417);
          ...
          case 6:
            try {
              _models_userModel__WEBPACK_IMPORTED_MODULE_3__.default.findOne({
                ...
                user.salt = new Buffer(crypto__WEBPACK_IMPORTED_MODULE_4___default().randomBytes(16).toString("base64"), "base64");
                user.password = crypto__WEBPACK_IMPORTED_MODULE_4___default().pbkdf2Sync(req.body.password, user.salt, 10000, 64, "sha1").toString("base64");
                user.save();
                return res.json({
...
var __webpack_exports__ = (__webpack_exec__(4846));
