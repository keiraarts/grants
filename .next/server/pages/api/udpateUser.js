...
/* harmony import */ var _models_userModel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3309);
/* harmony import */ var crypto__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(6417);
...
function _handler() {
  _handler = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2(req, res) {
    var method;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _context2.t0 = method;
            _context2.next = _context2.t0 === "POST" ? 6 : 8;
            break;
          ...
          case 6:
            try {
              _src_server_services_authorization_service__WEBPACK_IMPORTED_MODULE_2___default()(req.headers.authorization, res, function (jwt) {
                _models_userModel__WEBPACK_IMPORTED_MODULE_6__.default.findById(jwt.id, /*#__PURE__*/function () {
                  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(err, user) {
                    var existingApplication, exists, exists2, emailToken;
                    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          ...
                          case 4:
                            if (!req.body.username || !req.body.email) res.json({
                          ...
                          case 7:
                            ...
                            if (!(existingApplication && (!req.body.first || !req.body.last || !req.body.birthYear || !req.body.artistName || !req.body.country || !req.body.countryCode || !req.body.city || !req.body.website || !req.body.twitter || !req.body.instagram))) {
                              _context.next = 10;
                              break;
                            }

                            return _context.abrupt("return", res.json({
                              error: "You must have all fields completed until your art submission is processed"
                            }));

                          case 10:
                            _context.next = 12;
                            return _models_userModel__WEBPACK_IMPORTED_MODULE_6__.default.findOne({
                              email: {
                                $regex: new RegExp("^".concat(req.body.email.toLowerCase().trim(), "$"), "i")
                              }
                            });
                          ...
                          case 20:
                            ...
                            if (user.email !== req.body.email.toLowerCase().trim()) {
                              emailToken = crypto__WEBPACK_IMPORTED_MODULE_7___default().randomBytes(32).toString("hex");
                              user.emailVerified = false;
                              user.emailToken = emailToken;
                              user.email = req.body.email.toLowerCase().trim();
                              transporter.sendMail(_src_server_emails_templates__WEBPACK_IMPORTED_MODULE_3__.verification(user.email, user.username, user.emailToken));
                            }
                            ...
                            user.save();
                            return _context.abrupt("return", res.json("Profile updated"));
...
var __webpack_exports__ = (__webpack_exec__(7527));
