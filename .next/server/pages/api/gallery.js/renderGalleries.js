    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 13:
            _context.next = 15;
            return _models_galleryModel__WEBPACK_IMPORTED_MODULE_3__/* .default.find */ .Z.find({
              user: jwt.id
            });
          ...
          case 18:
            req.body.galleries.forEach(function (gallery) {
              galleries.forEach(function (find) {
...
var __webpack_exports__ = (__webpack_exec__(1847));
