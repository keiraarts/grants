    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.t0 = method;
            _context.next = _context.t0 === "POST" ? 6 : 24;
            break;

          case 6:
            _context.prev = 6;
            _context.next = 9;
            return _models_userModel__WEBPACK_IMPORTED_MODULE_3__.default.findById(req.body.user);
          ...
          case 14:
            ...
            galleries.forEach(function (gallery) {
              var nfts = gallery.nfts;

              var sorted = _.sortBy(nfts, ["order"]);
...
var __webpack_exports__ = (__webpack_exec__(7507));
