    ...
    <div className="content-block">
      ...
      <div className="page-container text-m">
        <a
          ...
          onClick={() =>
            openLink("https://www.youtube.com/watch?v=a8ww4aNlPQU")
          }
        >
        ...
        <a
          ...
          onClick={() =>
            openLink(
              "https://www.loop-news.com/p/beginners-guide-crypto-art-and-nfts"
            )
          }
        >
        ...
        <a
          className="text-grey pointer margin-top"
          onClick={() =>
            openLink("https://parishilton.com/why-im-excited-about-nfts/")
          }
        >
        ...
        <a
          className="text-grey pointer margin-top"
          onClick={() => openLink("https://discord.gg/a9dDyUCZWY")}
        >
        ...
        <a
          className="text-grey pointer margin-top"
          onClick={() => openLink("https://goldstandard.org")}
        >
