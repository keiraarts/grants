    ...
    <div className='content-block'>
      ...
      <div className='page-container margin-top'>
        ...
        <Block title='What makes an NFT so profound?' text={ `Due to the nature of the blockchain, it can be globally exchanged with another without any middlemen or friction
          ...
          ownership over.` } />
        <Block title={ `Can't someone just copy and paste artwork?` } text={ `Yes, and in this context that's a good thing as it means that artwork is being shared with more visibility. But that person does not own the asset!
        ...
        <Block title={ `Which blockchain does Sevens use?` } text={ `Our NFTs are on the Ethereum blockchain. We owe Ethereum immense thanks for making this all possible. We chose Ethereum because
          the amount of tooling and infrastructure is extremely robust and standardized in a way no other blockchain is.` } />
        <Block title={ `Network usage fees are too high are they not?` } text={ `This is absolutely correct - current gas costs are unacceptable. It is the reason Sevens Foundation was created, to allow a launchpad
        ...
        <Block title={ `The environmental impacts are not acceptable?` } text={ `No they are not, and we are committed to reducing carbon footprint as an organization. However, 
