  ...
  return (
    <div className='content-block'>
      ...
      <div className='page-container margin-top ethos-text'>
        ...
        <br /><br />
        Our first grants program, Genesis Grant, included a cohort of 317 artists from 60 different countries - most of whom have been disadvantaged by means beyond their control.
