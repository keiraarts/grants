  ...
  return (
    <div className='content-block'>
      ...
      <div className='page-container margin-top ethos-text'>
        ...
        We are a global <Link to='/committee' className='remove-a'>committee</Link> with a mission to spotlight emerging artists and share their creativity with the world.
        <br /><br />
        ...
        In the meantime we will offset the emissions produced by each and every NFT we mint by planting trees in partnership with <span className='remove-a pointer' onClick={ () => openLink('https://teamtrees.org/') }>#teamtrees</span>.
        ...
        <br /><br />
        We give much gratitude to our <Link to='/donate' className='remove-a' onClick={ () => window.scrollTo(0, 0) }>donors</Link>.
        <br /><br />
      </div>
    </div>
  );
