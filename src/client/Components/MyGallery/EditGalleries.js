...
export default function EditGalleries({ galleries, setManage, setDel, setGalleries }) {
                            ...
                            <div className='reorder-block flex'>
                              ...
                              <div className='flex-full'>
                                ...
                                <div className='flex margin-top-s'>
                                  <div className='small-button' onClick={ () => setManage(gallery) } >
                                    <div className='text-s'>Manage</div>
                                  </div>
                                  <div className='small-button margin-left-s' onClick={ () => setDel(gallery) } >
