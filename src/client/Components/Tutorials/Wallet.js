    ...
    <div className='content-block'>
      ...
      <div className='page-container margin-top'>
        ...
        <div className='text-s margin-top-s'>
          MetaMask is the recommended wallet to interact with NFT platforms as well as other apps on Ethereum.
          <br /><br />Get the <span className='pointer text-grey' onClick={ () => openLink('https://metamask.io/download.html') }>Chrome Extension</span> (Recommended) and/or install the app on a mobile device.
        </div>
        ...
        <div className='text-s margin-top-s'>
          ...
          this is your password and access key. You can use these 12 words to share the same wallet account on both browser and mobile app.
          <br /><br />
          The best way to ensure you won't lose your password is to write down these 12 words and give it to a family member or friend who you trust with your life as a backup in case you lose yours.
          <br /><br />
          If you would like the strongest security option, consider getting a <span className='pointer text-grey' onClick={ () => openLink('https://medium.com/radartech/hardware-wallets-explained-da8bd93ce801') }>hardware wallet</span> to connect via browser.
        </div>
        <div className='text-m margin-top'>
        ...
        <div className='text-s margin-top-s'>
          ...
          <br /><br />
          <i>Grant recipients will receive all ETH necessary directly from Sevens to participate</i>
        </div>
        <br />
      </div>
    </div>
