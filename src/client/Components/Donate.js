      ...
      <div className="page-container">
        <div className="text-s margin-top text-desc">
          ...
          <span
            ...
            onClick={() =>
              openLink("https://etherscan.io/address/foundation.eth")
            }
          >
            foundation.eth
          </span>{" "}
        ...
        <span
          className="text-s margin-top-s text-grey pointer"
          onClick={() => openLink("https://www.sothebys.com/en/")}
        >
          Sotheby's
        </span>
        ...
        <span
          className="text-s margin-top-s text-grey pointer"
          onClick={() => openLink("https://friendswithyou.com/")}
        >
          FriendsWithYou
        </span>
        <div className="text-s">Gold Donor</div>
        <span
          className="text-s margin-top-s text-grey pointer"
          onClick={() => openLink("https://diplo.com/")}
        >
          Diplo
        </span>
        <div className="text-s">Gold Donor</div>
        <span
          className="text-s margin-top-s text-grey pointer"
          onClick={() => openLink("https://www.saveartspace.org/team")}
        >
          Justin Aversano
        </span>
        <div className="text-s">Gold Donor</div>
        <span
          className="text-s margin-top-s text-grey pointer"
          onClick={() => openLink("https://twitter.com/illestrater_")}
        >
          Tim Kang
        </span>
        <div className="text-s">Gold Donor</div>
        <span
          className="text-s margin-top-s text-grey pointer"
          onClick={() => openLink("https://twitter.com/WhaleShark_Pro")}
        >
          Whaleshark
        </span>
        ...
        <span
          className="text-s margin-top-s text-grey pointer"
          onClick={() => openLink("https://twitter.com/etyoung")}
        >
          Eric Young
        </span>
        <div className="text-s">Silver Donor</div>
        <span
          className="text-s margin-top-s text-grey pointer"
          onClick={() => openLink("https://twitter.com/ediep")}
        >
          Eric Diep
        </span>
        <div className="text-s">Silver Donor</div>
        <span
          className="text-s margin-top-s text-grey pointer"
          onClick={() => openLink("https://twitter.com/Weel25067618")}
        >
          Weel
        </span>
