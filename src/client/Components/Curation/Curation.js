            ...
            <div className='frame gallery-art-container'>
              <div className='frame-shadow'>
                { imageType === 'mp4' ?
                  ...
                  :
                  <div>
                    <img className={ `gallery-art ${ !loaded && 'hidden'}` } src={ `https://cdn.grants.art/${ nft.art }` } onLoad={ () => setLoaded(true) } />
                    <img className={ `gallery-art ${ loaded && 'hidden '}` } src={ `https://cdn.grants.art/${ nft.artWeb }` } />
                  </div>
                }
              </div>
            </div>
