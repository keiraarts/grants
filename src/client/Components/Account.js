        ...
        <div className='page-container'>
          { editingAccount &&
            <div>
              ...
              <div className='form__group field'>
                <input type='email' className='form__field' placeholder='Email' name='email' id='email' required maxLength='100' value={ updateUser.email } onChange={e => setUpdateUser({ ...updateUser, email: e.target.value })} />
                <label className='form__label'>Email</label>
              </div>
              <div className='form__group field'>
                <input type='text' className='form__field' placeholder='First Name' name='first' id='first' required maxLength='100' value={ updateUser.first } onChange={e => setUpdateUser({ ...updateUser, first: e.target.value })} />
                <label className='form__label'>First Name</label>
              </div>
              <div className='form__group field'>
                <input type='text' className='form__field' placeholder='Last Name' name='last' id='last' required maxLength='100' value={ updateUser.last } onChange={e => setUpdateUser({ ...updateUser, last: e.target.value })} />
                <label className='form__label'>Last Name</label>
              </div>
              <div className='form__group field'>
                <input type='text' className='form__field' placeholder='Last Name' name='last' id='last' required maxLength='100' value={ updateUser.artistName } onChange={e => setUpdateUser({ ...updateUser, artistName: e.target.value })} />
                <label className='form__label'>Artist Name</label>
              </div>
              <div className='form__group field'>
                <input type='text' className='form__field' placeholder='Name' name='name' id='name' value={ updateUser.birthYear } maxLength='4' onChange={e => setUpdateUser({ ...updateUser, birthYear: e.target.value })} />
              ...
              <div className='select-dropdown margin-top-minus'>
                <select name='Country' className='text-black' defaultValue={ updateUser.country || 'default' } value={ updateUser.country } required onChange={e => setUpdateUser({ ...updateUser, country: e.target.value, countryCode: CountryList.getCode(e.target.value) })}>
              ...
              <div className='form__group field'>
                <input type='text' className='form__field' placeholder='City' name='city' id='city' maxLength='100' value={ updateUser.city } onChange={e => setUpdateUser({ ...updateUser, city: e.target.value })} />
                <label className='form__label'>City</label>
              </div>
              <div className='form__group field'>
                <input type='url' className='form__field' placeholder='URL' name='url' id='url' required maxLength='100' value={ updateUser.website } onChange={e => setUpdateUser({ ...updateUser, website: e.target.value })} />
                <label className='form__label'>Website / Artwork URL</label>
              </div>
              <div className='form__group field'>
                <textarea type='text' className='form__field intent-field' placeholder='About' name='about' id='about' required maxLength='777' value={ updateUser.about } onChange={e => setUpdateUser({ ...updateUser, about: e.target.value })} />
                <label className='form__label'>About (777 Chars)</label>
              </div>
              <div className='form__group field'>
                <input type='text' className='form__field' placeholder='Instagram' name='instagram' id='instagram' maxLength='100' value={ updateUser.instagram } onChange={e => setUpdateUser({ ...updateUser, instagram: e.target.value })} />
              ...
              <div className='form__group field'>
                <input type='text' className='form__field' placeholder='Twitter' name='twitter' id='twitter' required maxLength='100' value={ updateUser.twitter } onChange={e => setUpdateUser({ ...updateUser, twitter: e.target.value, twitterVerified: false })} />
            ...
            <div>
              ...
              <div className='text-s'>
                { provider && provider.selectedAddress ?
                  <div>{ provider.selectedAddress }</div>
                :
                  <div className='margin-top-s'>
                    <div className='small-button' onClick={ () => connectWallet() }>Connect your wallet</div>
                  </div>
                }
                { (provider && provider.selectedAddress && auth && auth.wallet !== provider.selectedAddress) &&
                  <div className='margin-top-s'>
                    <div className='small-button' onClick={ verifyWallet }>Verify Wallet</div>
                  </div>
                }
              </div>
              { (!verifiedWallet) &&
