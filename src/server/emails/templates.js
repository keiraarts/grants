  ...
  return {
    ...
    <![endif]-->
      ...
      <![endif]-->
        ...
        <tbody>
          <tr>
            <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-family: georgia, serif">Hey ${ username }!</span></div>
...
function minted(email, artistName, exhibition, url) {
  return {
    from: '"Sevens Foundation ❤️" <love@grants.art>',
    to: email,
    subject: 'Sevens Artwork Minted',
    ...
    <![endif]-->
      ...
      <![endif]-->
        ...
        <tbody>
          <tr>
            <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-family: georgia, serif">Hello ${ artistName } - your artwork and NFT for ${ exhibition } has finally been minted!</span></div>
    <div style="font-family: inherit; text-align: inherit"><br></div>
    <div style="font-family: inherit; text-align: inherit"><span style="font-family: georgia, serif">We're incredibly excited and thankful to provide a home for your work, and we hope we are doing your artwork full justice with our presentation style, commitment to integrity, and benevolent curation.</span></div>
    <div style="font-family: inherit; text-align: inherit"><br></div>
    <div style="font-family: inherit; text-align: inherit"><span style="font-family: georgia, serif">As you are now part of the Sevens family, please do feel free to reach out to tim@grants.art if you have any criticisms or suggestions at all on how we can improve to do things better for you and future participants.</span></div><div></div></div></td>
          </tr>
        </tbody>
      </table><table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="865c9c04-32ba-4198-b27d-f9e0d0e734bc">
          <tbody>
