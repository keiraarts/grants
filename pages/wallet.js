      ...
      <div className="content-block">
        ...
        <div className="page-container margin-top">
          ...
          <div className="text-s margin-top-s">
            ...
            to do this as this is your password and access key. You can use
            these 12 words to share the same wallet account on both browser and
            mobile app.
            <br />
            <br />
            The best way to ensure you won't lose your password is to write down
            these 12 words and give it to a family member or friend who you
            trust with your life as a backup in case you lose yours.
            <br />
            <br />
